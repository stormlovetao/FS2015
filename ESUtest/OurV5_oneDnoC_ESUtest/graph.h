...
public:
	...
	int get_vertex();
	string gettree(vertex ** subgraph, int level);
        string getgraph(vertex ** subgraph, int level);
        string getgraph_eff(vertex ** subgraph, int level,bool *IsD);
        string getgraph_key(vertex ** subgraph, int level,bool *IsD);//new representation of graphKey
        string gettree_eff(vertex ** subgraph, int level,bool *IsD);
    string gettree_cam(vertex ** subgraph, int level);
private:
    FILE *am;
